            ...
            <div class="row">
               ...
               <div class="col-lg-8">
                <div class="control">
                    ...
                    <div>
                        <input type="text" id="fixed_amount" value="{{$Offer->offer_amount}}" name="offer_amount" placeholder="Enter Flate Amount" class="form-control my-2 disabled-1"  placeholder="Offer Amount">
                        <input type="text" id="percentage_amount" value="{{$Offer->offer_percentage}}" name="offer_percentage" placeholder="Enter Percentage Amount" class="form-control my-2 disabled">
                    </div>
                </div>
                </div>
               ...
               <div class="col-md-4">
                  ...
                  <input type="text" id="minimum_perchase" value="{{$Offer->minimum_perchase}}" name="minimum_perchase" class="form-control first-line" placeholder="Emter Minimum Purchase Amount">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                   ...
                   <input type="text" value="{{ $Offer->affiliate_url }}" id="affiliate_url" name="affiliate_url" placeholder="Enter Affiliate Url" class="form-control my-2">
                </div>
             </div>
               <div class="col-md-8">
                  <div class="form-group">
               ...
               <div class="form-group text-center">
                  @if($advertisement)
                     <input type="submit" value="Save & Pay" class=" my-2 btn btn-info btn-submit">
                  @else
