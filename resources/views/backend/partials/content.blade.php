                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Total  Offer</span>
                          <h3 class="card-title mb-2">{{ $totalOffers }}</h3>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1">{{ $totalClient }}</h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Total Merchant</span>
                          <h3 class="card-title text-nowrap mb-2">{{ $totalMerchant }}</h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Todays Qr Code</span>
                          <h3 class="card-title mb-2">{{ $todaysQrCodeCount }}</h3>
