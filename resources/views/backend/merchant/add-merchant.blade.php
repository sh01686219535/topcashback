                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="merchant_name"  placeholder="Enter Merchant Full Name" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                            <label for="company_name"><strong>Company Name</strong></label>
                                            <input type="text" id="company_name" name="company_name"  placeholder="Enter Company Name" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                            <label for="number"><strong>Merchant Contact Number</strong></label>
                                            <input type="text" id="number" name="merchant_number" placeholder="Enter Merchant Contact Number" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                            <label for="number"><strong>Merchant Secondary  Contact Number</strong></label>
                                            <input type="text" id="merchant_secondary_number" name="merchant_secondary_number" placeholder="Enter Merchant Secondary Number" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-group">
                                            <label for="password" class="my-2"><strong>Merchant Password <span class="text-danger color-m"> *</span></strong></label>
                                        ...
                                        <div class="input-group input-group-merge form-group">
                                            <label for="password" class="my-2"><strong>Merchant Confirm Password <span class="text-danger color-m"> *</span></strong></label>
                                            <div class="input-group">
                                                <input
                                                    type="password"
                                                    id="confirm_password"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control my-2" name="merchant_image" id="image"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address" name="address"  placeholder="Enter address" class="form-control my-2" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="city"><strong>City</strong></label>
                                            <input type="text" id="city" name="city"  placeholder="Enter City" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                            <label for="area1"><strong>Area<span class="text-danger color-m"> *</span></strong></label>
                                            <select id="area" name="area" class="form-select my-2">
                                                @foreach($area as $items)
                                                <option value="{{$items->id}}">{{$items->areaName}}</option>
                                                @endforeach
                                            </select>
                                            <!-- <input type="text" id="area" name="area"  placeholder="Enter Area" class="form-control my-2" required> -->
                                        </div>
                                        <div class="form-group">
                                            <label for="postcode"><strong>Postcode<span class="text-danger color-m"> *</span></strong></label>
                                            <input type="text" id="postcode" name="postcode"  placeholder="Enter Postcode" class="form-control my-2" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" id="latitude" name="latitude" class="form-control my-2">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" id="longitude" name="longitude" class="form-control my-2">
                                        </div>
                                    </div>
                                </div>
