...
<div class="container">
    ...
    <div class="row">
        @if (Session::has('success'))
                    ...
                    <form 
                            role="form" 
                            action="{{ route('user.payment',$physicallyApprove->id) }}" 
                            method="post" 
                        ...
                        <div class="col-md-7" style="display:none">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" value="{{$percentage_amount}}" name="percentage_amount" class="form-control my-2">
                            </div>
                            @else
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="user_id" class="form-control my-2">
                                    ...
                                    <option value="{{$item->id}}" {{$item->id == $physicallyApprove->user_id  ? 'selected' : ''}}>{{$item->phone}}</option>
                                    @endforeach
                                </select>
                            </div>
                             <div class="form-group col-md-6">
                                <label for="">Offer</label>
                                <select name="offer_title_id" class="form-control my-2">
                             ...
                             <div class="form-group col-md-6">
                               <label for="">Percentage Amount</label>
                              <input type="text" value="{{$percentage_amount}}" name="purchase_amount" class="form-control my-2">
                            </div>
                        </div>
                          <div class="col-md-5" style="margin:30px 0 0 340px;">
